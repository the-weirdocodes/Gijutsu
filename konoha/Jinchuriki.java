...
#Weaving Strength and Chakra together makes a jutsu. Similarly, properties, members and behavior weave a class. 
...
memory directly from  the class while it is loading to compile. Static method needs static members thus, doesn't accept 
instances members. 
...
into them. Can be used by any other behavior too.
 ...
 Likewise each and every class, behavior and members comes to the main method for execution. It all starts with 
